...
**水果目录** 是一个轻量级、版本可控的水果集合，附带命令行管理工具。它既是 Git 分支管理、合并冲突解决、协作工作流的实战演示项目，也是一份简单有趣的数据集。
...
需要 Python 3.8+，直接运行 `fruits.py`：

```bash
# 查看所有水果
python fruits.py list
...
# 按字母排序
python fruits.py sort

# 统计数量
python fruits.py count

# 随机推荐
python fruits.py random

# 移除一种水果
python fruits.py remove 榴莲
```
...
3. 使用 CLI 添加：`python fruits.py add 你的水果`
